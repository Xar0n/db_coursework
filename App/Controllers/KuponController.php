...
class KuponController extends ControllerTwig
{
    ...
    protected function actionAdd()
    {
        $overflow = false;
        if (isset($_POST['save'])) {
            $number = filter_input(INPUT_POST, 'nomer_bileta', FILTER_SANITIZE_NUMBER_INT);
        ...
        $this->view->display('kupon/add.twig', ['bilets' => $bilets, 'klients' => $klients, 'overflow' => $overflow]);
    }
    ...
    protected function actionEdit()
    {
        ...
        $this->view->display('kupon/edit.twig', ['kupon' => $kupon, 'bilets' => $bilets, 'klients' => $klients, 'overflow' => $overflow]);
    }
